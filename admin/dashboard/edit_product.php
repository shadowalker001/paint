...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin Edit Product | <?= $app->app_title ?></title>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    if (!$btnId) {
                        print '<script type="text/javascript"> self.location = "' . $app->server_root_dir('admin/dashboard/manage_products') . '" </script>';
                    }

                    $db_handle = $dbh->prepare("SELECT * FROM pt_products WHERE id=:id LIMIT 1");
                    ...
                    ?>
                            ...
                            <div class="row" style="overflow: auto;">
                                <div class="col-sm-8 offset-2">
                                    <div class="card mt-5">
                                        <div class="card-body">
                                            <form method="POST" id="updateProductForm" action="" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group mb-3">
                                                            <label for="">Product Picture <i class="text-danger">*not required if you do not wish to update the previous Picture</i></label>
