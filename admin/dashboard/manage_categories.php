...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin Manage Categories | <?= $app->app_title ?></title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card mt-5">
                                <?php
                                $querySQL = "SELECT * FROM pt_categories ORDER BY category, id DESC";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr data-id="<?= $counter ?>" style="cursor: pointer;">
                                                            <td><?= $counter ?></td>
                                                            <td><?php echo $paramGetFields->category; ?></td>
                                                            ...
                                                            <td>
                                                                <a style="width: 100%;" btnId='<?= $paramGetFields->id ?>' btnType='categories' id="user<?= $paramGetFields->id ?>" href="#" class="btn btn-<?= ($paramGetFields->status == '0') ?  'success activateBtn' : 'warning deactivateBtn'; ?>"><i class="fas fa-key"></i> <?= ($paramGetFields->status == '0') ?  'Activate' : 'Deactivate'; ?></a>
                                                            </td>
                                                            <td>
                                                                <a style="width: 100%;" btnId='<?= $paramGetFields->id ?>' btnType='categories' href="#" class="btn btn-outline-danger deleteBtn"><i class="fas fa-trash"></i> Delete</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                        $counter++;
