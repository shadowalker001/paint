...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin Manage Students | <?= $app->app_title ?></title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card mt-5">
                                <?php
                                $querySQL = "SELECT * FROM pv_students";
                                            ...
                                            <table class="table table-editable table-nowrap align-middle table-edits">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr data-id="<?=$counter?>" style="cursor: pointer;">
                                                        <td><?=$counter?></td>
                                                        <td><?php echo $paramGetFields->fname; ?></td>
                                                        <td><?php echo $paramGetFields->reg_no; ?></td>
                                                        <td><?php echo $paramGetFields->email; ?></td>
                                                        <td><img class="img-rounded img-circle" src="../../assets/images/<?php echo $paramGetFields->picture; ?>" height="40" alt=""></td>
                                                        ...
                                                        <td>
                                                            <a style="width: 100%;" btnId='<?= $paramGetFields->id ?>' id="user<?= $paramGetFields->id ?>" href="#" class="btn btn-<?= ($paramGetFields->status == '0') ?  'success activateUser' : 'warning deactivateUser'; ?>"><i class="fas fa-key"></i> <?= ($paramGetFields->status == '0') ?  'Activate' : 'Deactivate'; ?></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                        $counter++;
