                            ...
                            <div class="col-md-4 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?=$app->getCount("pt_admin") ?></span></h4>
                                            <p class="text-muted mb-0">Registered Admin</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="resize-triggers"><div class="expand-trigger"><div style="width: 46px; height: 47px;"></div></div><div class="contract-trigger"></div></div></div>
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?=$app->getCount("pt_products") ?></span></h4>
                                            <p class="text-muted mb-0">Registered Products</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="resize-triggers"><div class="expand-trigger"><div style="width: 46px; height: 47px;"></div></div><div class="contract-trigger"></div></div></div>
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?=$app->getCount("pt_products", "WHERE status !=0") ?></span></h4>
                                            <p class="text-muted mb-0">Purchased Products</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
