...
<body class="template-collection has-smround-btns has-loader-bg equal-height has-sm-container">
                        ...
                        <div class="hdr-links-wrap col-auto ml-auto">
                            <div class="hdr-inline-link">
                                ...
                                <div class="dropdn dropdn_fullheight minicart">
                                    <a href="cart" class="dropdn-link js-dropdn-link minicart-link"
                ...
                <div class="row">
                    <div class="col-lg aside">
                        <div class="prd-grid-wrap">
                            <div class="prd-listview product-listing data-to-show-3 data-to-show-md-3 data-to-show-sm-2 js-category-grid"
                                        ...
                                        <div class="prd-info">
                                            <div class="prd-info-wrap">
                                                ...
                                                <div class="prd-action">
                                                    <form action="category-listview.html#">
    ...
    <div class="footer-sticky">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-auto popup-addedtocart_actions">
                        <span>You can continue</span> <a href="category-listview.html#"
                            ...
                            href="checkout.html" class="btn btn--invert btn--sm"><i
        ...
        <a class="back-to-top js-back-to-top compensate-for-scrollbar" href="category-listview.html#"
            title="Scroll To Top">
                ...
                <div class="payment-notification-inside">
                    <div class="payment-notification-container">
                        <a href="category-listview.html#" class="payment-notification-image js-pn-link">
                            <img src="https://big-skins.com/frontend/foxic-html-demo/images/products/product-01.webp"
                                class="js-pn-image" alt="">
                        </a>
