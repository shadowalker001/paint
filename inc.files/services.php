<!-- services area start -->
<section class="services__area p-relative z-index-11 pt-130 pb-55" id="services">
    <div class="services__bg" data-background="static/img/services/services-bg.jpg"></div>
    <div class="container">
        <div class="row">
...
<section class="skill__area pb-135 pt-50 p-relative z-index-1">
    <div class="skill__shape">
        <img class="skill__shape-1" src="static/img/skill/skill-shape-1.png" alt="">
    </div>
    <div class="container">
        <div class="row">
