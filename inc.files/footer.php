                            ...
                            <div class="footer__widget-content">
                                <div class="footer__widget-about">
                                    ...
                                    <div class="footer__logo">
                                        <a href="index.html">
                                            <img src="static/img/logo/logo-white.png" alt="logo">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="footer__widget pl-60 footer__pr-40 mb-50">
                            ...
                            <div class="footer__widget-content">
                                <div class="footer__link">
                                    <ul>
                                        <li>
                                            <a href="index.html#">Residential Interior</a>
                                        </li>
                                        <li>
                                            <a href="index.html#">Commercial Interior</a>
                                        </li>
                                        <li>
                                            <a href="index.html#">Industrial Interior</a>
                                        </li>
                                        <li>
                                            <a href="index.html#">Roof Servicing</a>
                                        </li>
                                        <li>
                                            <a href="index.html#">Color Mixing</a>
                                        </li>
                                        <li>
                                            <a href="index.html#">Painting & Decoration</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="footer__info">
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-start">
                                            ...
                                            <div class="footer__info-text">
                                                <h4>Email Us</h4>
                                                <a href="https://themepure.net/cdn-cgi/l/email-protection#14676164647b6660547379757d783a777b79"><span class="__cf_email__" data-cfemail="e0939590908f9294a0878d81898cce838f8d">[email&#160;protected]</span></a>
                                            </div>
                                        </li>
                                        <li class="d-flex align-items-start">
                                            <div class="footer__info-icon mr-20">
